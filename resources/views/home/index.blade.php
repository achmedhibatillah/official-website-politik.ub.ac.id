    ...
    <div class="row m-0 p-0 justify-content-center">
        <div class="col-11 col-md-10 col-lg-9 col-xl-7 text-clr3 row m-0 p-0" style="max-width: 1250px;">
            <div class="col-md-6 m-0 p-0 d-flex align-items-center">
                <div>
                    <h5 class="m-0 mb-3 text-clr3">@lang('home.prodi')</h5> 
                    <h2 class="m-0 fw-800 text-clr1">@lang('home.ilpol')</h2>
                    <h5 class="m-0 lh-1 text-clr1">@lang('home.fisip')</h5>
                    <div class="d-flex align-items-end gap-2">
                        <h5 class="m-0 text-clr1">@lang('home.ub')</h5>
                    ...
                    <a href="" class="btn btn-outline-clr3 btn-sm mt-4">@lang('home.selengkapnya')</a>
                    <div class="my-5 my-md-0 d-block d-md-none">.</div>
                </div>
            </div>
            <div class="col-md-6 m-0 p-0 d-flex justify-content-center position-relative">
                <div class="m-0 rounded shadow-l p-3 ms-0 ms-md-5 border-clr3 wr-100 bg-web d-flex align-items-end justify-content-center" style="background-image: url('{{ asset('assets/images/dynamic/main.png') }}');min-height:280px;">
                    <div class="bg-clr4 rounded border-clr3 shadow-l w-100">
    ...
    <div class="bg-clr2 mb-5 row justify-content-center position-relative" style="margin:120px 0 0 0;z-index:2;">
        <div class="col-11 col-md-10 col-lg-9 col-xl-7 text-clr3 m-0 p-0 py-3 position-relative" style="max-width: 1250px;">
            <div class="position-absolute d-flex" style="top:-30px">
                ...
                <h5 class="text-clr2">@lang('home.pengumuman_terbaru')</h5>
            </div>
                ...
                @foreach($pengumuman as $x)
                    <div class="col-md-6 m-0 p-1">
                        <div class="border-clr5 p-3 text-clr5 d-flex align-items-center" style="height:65px;">
                            <p class="lh-1 m-0 hide-text-2"><a href="{{ url('pengumuman/' . $x->pengumuman_slug) }}" class="td-hover text-clr5">{{ $x->pengumuman_judul }}</a></p>
                        </div>
                    </div>
                @endforeach
            </div>
            <p class="ms-1 mt-3 m-0"><a href="{{ url('pengumuman') }}" class="td-hover text-clr5">@lang('home.lihat_pengumuman_lain') →</a></p>
