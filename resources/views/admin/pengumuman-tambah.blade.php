<form action="{{ url('admin-simpan-pengumuman') }}" method="post">
    @csrf
    <div class="d-flex justify-content-center align-items-center w-100 text-clr3" style="height:100%;">
        <div class="w-100">
            ...
            <div class="d-none border-clr3 p-3 overflow-y-scroll" style="height:70vh;" id="PengumumanIsiID">
                ...
                @enderror
                <div>
                    <textarea name="pengumuman_isi_ID" class="border-clr1 m-0">{{ old('pengumuman_isi_ID') }}</textarea>
            ...
            <div class="d-none border-clr3 p-3 overflow-y-scroll" style="height:70vh;" id="PengumumanIsiEN">
                ...
                @enderror
                <div>
                    <textarea name="pengumuman_isi_EN" class="border-clr1 m-0">{{ old('pengumuman_isi_EN') }}</textarea>
                    <script src="https://cdn.ckeditor.com/4.18.0/standard/ckeditor.js"></script>
                    <script>
