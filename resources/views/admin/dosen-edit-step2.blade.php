        ...
        <form action="{{ url('admin-simpan-dosen/step-2') }}" method="post">
            ...
            <div class="mb-3 row m-0 p-0">
                <div class="col-md-6 m-0 p-0 pe-0 pe-md-1">
                    ...
                    value="{{ old('dosen_konsentrasi_ID', $dosen->dosen_konsentrasi_ID) }}">
                </div>
                ...
                <label for="dosen_konsentrasi_EN">Konsentrasi <i class="lang-en"></i></label>
                    ...
                    value="{{ old('dosen_konsentrasi_EN', $dosen->dosen_konsentrasi_EN) }}">
                </div>
                <div class="col-md-6 m-0 p-0 pe-0 pe-md-1">
            ...
            <div class="mb-3 row m-0 p-0">
                <div class="col-md-6 m-0 p-0 pe-0 pe-md-1">
                    ...
                    value="{{ old('dosen_keahlian_ID', $dosen->dosen_keahlian_ID) }}">
                </div>
                <div class="col-md-6 m-0 p-0 ps-0 ps-md-1">
                <label for="dosen_keahlian_EN">Keahlian (SK Dekan) <i class="lang-en"></i></label>
                    ...
                    value="{{ old('dosen_keahlian_EN', $dosen->dosen_keahlian_EN) }}">
                </div>
                <div class="col-md-6 m-0 p-0 pe-0 pe-md-1">
            ...
            <div class="mb-3">
                ...
                value="{{ old('dosen_scholar', $dosen->dosen_scholar) }}">
                @error('dosen_scholar')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                value="{{ old('dosen_orcid', $dosen->dosen_orcid) }}">
                @error('dosen_orcid')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                value="{{ old('dosen_scopus', $dosen->dosen_scopus) }}">
                @error('dosen_scopus')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                value="{{ old('dosen_sinta', $dosen->dosen_sinta) }}">
                @error('dosen_sinta')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                value="{{ old('dosen_s1', $dosen->dosen_s1) }}">
                @error('dosen_s1')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                value="{{ old('dosen_s2', $dosen->dosen_s2) }}">
                @error('dosen_s2')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                value="{{ old('dosen_s3', $dosen->dosen_s3) }}">
                @error('dosen_s3')
                <div class="ms-1 fsz-10 mt-1 text-clr1"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                @enderror
            </div>
