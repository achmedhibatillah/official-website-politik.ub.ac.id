<form action="{{ url('admin-simpan-berita') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="d-flex justify-content-center align-items-center w-100 text-clr3" style="height:100%;">
        <div class="w-100">
            ...
            <div class="d-none border-clr3 p-3 overflow-y-scroll" style="height:70vh;" id="BeritaIsiID">
                ...
                @enderror
                <div>
                    <textarea name="berita_isi_ID" class="border-clr1 m-0">{{ old('berita_isi_ID') }}</textarea>
            ...
            <div class="d-none border-clr3 p-3 overflow-y-scroll" style="height:70vh;" id="BeritaIsiEN">
                ...
                @enderror
                <div>
                    <textarea name="berita_isi_EN" class="border-clr1 m-0">{{ old('berita_isi_EN') }}</textarea>
                    <script src="https://cdn.ckeditor.com/4.18.0/standard/ckeditor.js"></script>
                    <script>
